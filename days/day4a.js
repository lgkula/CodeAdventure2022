import { removeFromArray, checkIfAnyOfTheArraysFullyContainsTheOther } from '../tools/arrayTools.js';
import { getArrayFromFileLines } from '../tools/fileTools.js';
import { EMPTY_ARRAY, EMPTY_STRING, COMMA, HYPEN, ZERO } from '../tools/consts.js';
import fs from "fs";
...
const checkIfDuplicatedWorkInPair = (pair) => {
	...
	return checkIfAnyOfTheArraysFullyContainsTheOther(elf1, elf2);
}
